    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('product.update', $product->id) }}" class="mt-6 space-y-6 p-4"
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="position-relative space-preview-image">
                            ...
                            <img id="preview-image" src="{{!empty($product->image) ? Storage::url($product->image) : asset('images/no-image.png')}}" alt="preview image" class="preview-image" />
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" class="input-description mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" cols="30" rows="5" required>{{ $product->description }}
                        </textarea>
                    ...
                    <div>
                        ...
                        <x-text-input id="stock" name="stock" type="number" class="mt-1 block w-full" value="{{ $product->stock }}"
                    ...
                    <div>
                        ...
                        <x-text-input id="supplier_email" name="supplier_email" type="email" class="mt-1 block w-full" value="{{$product->supplier_email}}" />
        ...
        <script>
            $(document).ready(function () {
                ...
                $('.close-image').click(function () {
                    $('#preview-image').attr('src', '{{!empty($product->image) ? Storage::url($product->image) : asset('images/no-image.png')}}');
